  ...
  <header class="milki-nav" :class="{ 'is-scrolled': isScrolled }">
    <div class="nav-container">
      ...
      <div class="nav-actions desktop-only">
        ...
        <a target="_blank" href="https://github.com/milkilabs/launcher/releases/latest/download/app-release.apk" class="btn-download">
          Download
        </a>
      </div>
    ...
    <div class="mobile-menu" :class="{ 'is-open': isMobileMenuOpen }">
      <nav class="mobile-nav-links">
        ...
        <a href="https://github.com/milkilabs/launcher/releases/latest/download/app-release.apk" class="btn-download mobile-btn" @click="closeMenu">Download APK</a>
      </nav>
    </div>
  </header>
</template>
