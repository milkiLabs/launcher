...
class HomeModelWriterTest {
    ...
    @Test
    fun update_widget_display_mode_to_popup_icon_frees_spanned_cells() {
        val widget = HomeItem.WidgetItem.create(
            appWidgetId = 9,
            providerPackage = "pkg.widget",
            providerClass = "WidgetProvider",
        ...
        assertTrue(modeResult is HomeModelWriter.Result.Applied)
        val iconWidget = (modeResult as HomeModelWriter.Result.Applied)
            .items
            .first() as HomeItem.WidgetItem
        assertEquals(WidgetDisplayMode.PopupIcon, iconWidget.displayMode)
        ...
        assertTrue(placeResult is HomeModelWriter.Result.Applied)
    }
