...
fun createAppInfoAction(packageName: String, actionHandler: (SearchResultAction) -> Unit): MenuAction {
    return MenuAction(
        label = "App info",
...
fun createUninstallAppAction(packageName: String, actionHandler: (SearchResultAction) -> Unit): MenuAction {
    return MenuAction(
        label = "Uninstall",
        icon = Icons.Filled.Delete,
        onClick = { actionHandler(SearchResultAction.UninstallApp(packageName)) },
        isDestructive = true
    )
}

fun createLaunchShortcutAction(shortcut: HomeItem.AppShortcut, actionHandler: (SearchResultAction) -> Unit): MenuAction {
...
fun createOpenAppWidgetsAction(appName: String, actionHandler: (SearchResultAction) -> Unit): MenuAction {
    return MenuAction(
        label = "Widgets",
