...
sealed class SearchResultAction {
    ...
    /**
     * User wants to uninstall an app.
     *
     * @property packageName The package name of the app
     */
    ...
    /**
     * User wants to open the widget picker for the app.
     *
     * @property appName The name of the app to filter widgets by
     */
    data class OpenAppWidgets(val appName: String) : SearchResultAction()
...
fun SearchResultAction.shouldCloseSearch(): Boolean = when (this) {
    ...
    is SearchResultAction.UninstallApp -> false
    is SearchResultAction.OpenAppWidgets -> true
